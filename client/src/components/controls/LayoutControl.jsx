    ...
    cose: {
            ...
            switch (edge.data('linkType')) {
                ...
                case 'reference':
                    return edge.data('isHard') ? 
                        (supportedLayouts.cose.edgeElasticityReferenceHard || 32)
                        : (supportedLayouts.cose.edgeElasticityReferenceSoft || 32);
                default:
                    return 32;
            }
        },
        ...
        idealEdgeLength: function (edge) {
            switch (edge.data('linkType')) {
                ...
                case 'reference':
                    return edge.data('isHard') ? 
                        (supportedLayouts.cose.idealEdgeLengthReferenceHard || 32)
                        : (supportedLayouts.cose.idealEdgeLengthReferenceSoft || 32);
                default:
                    return 32;
            }
        },
    ...
    euler: {
        ...
        springLength: (edge) => {
            switch (edge.data('linkType')) {
                ...
                case 'reference':
                    return edge.data('isHard') ? 
                        (supportedLayouts.euler.springLengthReferenceHard || 160)
                        : (supportedLayouts.euler.springLengthReferenceSoft || 160);
                default:
                    return 80;
            }
        },
        ...
        springCoeff: (edge) => {
            switch (edge.data('linkType')) {
                ...
                case 'component':
                    return supportedLayouts.euler.springCoeffComponent || 0.0008;
                case 'reference':
                    return edge.data('isHard') ? 
                        (supportedLayouts.euler.springCoeffReferenceHard || 0.0008)
                        : (supportedLayouts.euler.springCoeffReferenceSoft || 0.0008);
                default:
                    return 0.0008;
            }
        },
